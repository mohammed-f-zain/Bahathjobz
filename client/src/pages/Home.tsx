        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/auth/register?role=job_seeker" className="w-full sm:w-auto">
                <div
                  className="px-6 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center text-lg sm:text-xl"
                  style={{ 
                    backgroundColor: COLORS.white,
                    color: COLORS.dark
                  }}
              ...
              <Link to="/auth/register?role=employer" className="w-full sm:w-auto">
                <div
                  className="px-6 py-3.5 rounded-lg font-semibold border-2 shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center text-lg sm:text-xl"
                  style={{ 
